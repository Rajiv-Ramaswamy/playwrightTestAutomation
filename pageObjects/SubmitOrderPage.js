...
class SubmitOrderPage {
    ...
    async submitOrder(username, cardName, cardPrice, couponCode, sequentialText, country) {
        ...
        const countryList = this.countrySuggestions;
        ...
        const orderId = (await this.fetchOrderId.textContent()).replaceAll('|', '').trim();
