...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.goToWebpage = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a.apply(void 0, [_b.sent()]).toContain("Let's Shop");
                        return [4 /*yield*/, (0, test_1.expect)(this.welcomeHeader).toContainText('Rahul Shetty Academy')];
                    case 3:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    LoginPage.prototype.validLogin = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usernameField.fill(username)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.passwordField.fill(password)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.loginBtn.click()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.firstCard.nth(1).waitFor()];
                    case 4:
                        _a.sent(); // This is one way to wait for elements to load after login
                        return [2 /*return*/];
                }
            });
        });
