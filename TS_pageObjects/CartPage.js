...
var CartPage = /** @class */ (function () {
    ...
    CartPage.prototype.verifyCartAndCheckout = function (cardName, cardPrice) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.cartBtn.click()];
                    case 1:
                        _d.sent();
                        return [4 /*yield*/, this.continueShoppingBtn.waitFor()];
                    case 2:
                        _d.sent();
                        _a = test_1.expect;
                        return [4 /*yield*/, this.myCartText.textContent()];
                    case 3:
                        _a.apply(void 0, [_d.sent()]).toContain("My Cart");
                        _b = test_1.expect;
                        return [4 /*yield*/, this.cartItemHeading.textContent()];
                    case 4:
                        _b.apply(void 0, [_d.sent()]).toContain(cardName);
                        _c = test_1.expect;
                        return [4 /*yield*/, this.cartCardPriceText.textContent()];
                    case 5:
                        _c.apply(void 0, [_d.sent()]).toContain(cardPrice);
